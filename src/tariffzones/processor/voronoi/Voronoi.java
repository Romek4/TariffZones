...
public class Voronoi {
	...
	private ArrayList<Site> westSites = new ArrayList<>();
	private ArrayList<Site> eastSites = new ArrayList<>();
	private ArrayList<Site> northSites = new ArrayList<>();
	private ArrayList<Site> southSites = new ArrayList<>();
	...
	public Voronoi (List <Site> sites, double west, double east, double north, double south) {
		this.sites = sites;
		this.borderMinX = roundDouble(south-(north-south)/10);
		this.borderMaxX = roundDouble(north+(north-south)/10);
		this.borderMinY = roundDouble(west-(east-west)/10);
		this.borderMaxY = roundDouble(east+(east-west)/10);
		...
		westSites = new ArrayList<>();
		eastSites = new ArrayList<>();
		northSites = new ArrayList<>();
		southSites = new ArrayList<>();
	...
	private void checkSiteBorders(Edge e) {
		...
		if ((borderSite = intersects(e, westBorder)) != null) {
			...
			westSites.add(e.leftSite);
			westSites.add(e.rightSite);
		}
			...
			eastSites.add(e.leftSite);
			eastSites.add(e.rightSite);
		}
			...
			northSites.add(e.leftSite);
			northSites.add(e.rightSite);
		}
			...
			southSites.add(e.leftSite);
			southSites.add(e.rightSite);
		}
